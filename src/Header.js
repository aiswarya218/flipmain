            ...
            <header className="top-navbar">
                <div className="header-wrapper">
                    ...
                    <nav className="navbar-actions">
                        ...
                        <Link to="/more" className="action-link more-link">More</Link>
...
//       },
//       {
//         heading: "Televisions", // Adjusted for consistency
//         isFeatured: true,
//         subGroups: [
//           {
//             heading: "Speakers",
...
//               <img src="./images/filpkart.png" width="75" className="logoimg" alt="Logo" />
//               <span className="logo-plus">Explore
//                 <span className="plus-text">Plus</span>
//                 <img src="./images/plus_aef861.png" width="10" alt="Plus" />
//               </span>
//             </a>
//           </div>
...
//             <a href="#" className="seller-btn">Become a Seller</a>
//             <a href="#" className="more-btn">
//               More
//               {/* SVG for down arrow in 'More' button */}
//               <svg width="4.7" height="8" viewBox="0 0 16 27" xmlns="http://www.w3.org/2000/svg" className="Wto0b0">
//                 <path d="M16 23.207L6.11 13.161 16 3.093 12.955 0 0 13.161l12.955 13.161z" fill="#fff" className="-dC5Le" transform="rotate(-90 8 13.5)"></path>
//               </svg>
//             </a>
//             <a href="#" className="cart-btn"><i className="fas fa-shopping-cart"></i> Cart</a>
//           </nav>
//         </div>
//       </header>
...
//                     <DropdownColumn key={colIndex} column={column} />
//                   ))}
//                 </div>
//               )}
//             </li>
